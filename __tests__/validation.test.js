 ...
 * Run tests: node --test __tests__/validation.test.js
 *
 * Tests cover:
...
// Replicate the validation types and functions
function validateSkillPublication(skill) {
  const errors = [];
...
function createValidSkill(overrides = {}) {
  return {
    id: 'skill-123',
    name: 'Test Skill',
...
describe('validateSkillPublication', () => {
  ...
  describe('Missing Required Fields', () => {
    ...
    it('should reject missing description', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'description'));
    });
    ...
    it('should reject missing version', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'version'));
    });
    ...
    it('should reject missing creatorAgentId', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'creatorAgentId'));
    });
    ...
    it('should reject missing pricing', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'pricing'));
    });
    ...
    it('should reject missing dependencies', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'dependencies'));
    });
    ...
    it('should reject missing interface', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'interface'));
    });
    ...
    it('should reject missing packageUrl', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'packageUrl'));
    });
    ...
    it('should reject missing checksum', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'checksum'));
    });
    ...
    it('should reject missing performanceMetrics', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'performanceMetrics'));
    });
  });
  ...
  describe('Invalid Pricing', () => {
    it('should reject invalid pricing type', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'pricing.type'));
    });
    ...
    it('should reject negative pricing amount', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'pricing.amount'));
    });
    ...
    it('should reject missing pricing currency', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'pricing.currency'));
    });
  });
  ...
  describe('Invalid Performance Metrics', () => {
    it('should reject negative latency', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'performanceMetrics.avgLatencyMs'));
    });
    ...
    it('should reject success rate below 0', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'performanceMetrics.successRate'));
    });
  ...
  describe('Type Validation', () => {
    it('should reject null body', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert.strictEqual(result.errors[0].field, 'body');
    });
...
describe('validatePurchaseRequest', () => {
  ...
  describe('Missing Required Fields', () => {
    it('should reject missing buyerAgentId', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'buyerAgentId'));
    });
    ...
    it('should reject missing skillId', () => {
      ...
      assert.strictEqual(result.valid, false);
      assert(result.errors.some((e) => e.field === 'skillId'));
    });
